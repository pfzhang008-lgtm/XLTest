  ...
  <view class="container">
    ...
    <scroll-view scroll-y class="report-content" :style="{ paddingTop: contentPaddingTop + 'px' }">
      ...
      <view class="metrics-grid">
        <!-- PVT -->
        <view class="metric-card glass-card fade-in delay-2">
          <text class="metric-label">生理觉醒 (PVT)</text>
          <view class="metric-value-row">
            <text class="metric-score">450ms</text>
            <text class="metric-eval bad">迟滞</text>
          </view>
          <view class="progress-bar">
            <view class="progress-fill red-fill" style="width: 40%"></view>
          </view>
        </view>

        <!-- SART -->
        <view class="metric-card glass-card fade-in delay-2">
          <text class="metric-label">冲动抑制 (SART)</text>
          <view class="metric-value-row">
            <text class="metric-score">High Risk</text>
            <text class="metric-eval bad">失控</text>
          </view>
          <view class="progress-bar">
            <view class="progress-fill red-fill" style="width: 20%"></view>
          </view>
        </view>
      </view>

      <!-- Emotional Impact -->
      <view class="emotional-card glass-card fade-in delay-3">
        <view class="card-title-row">
        ...
        <text class="chart-desc">对“唠叨”、“比较”等词汇反应延迟显著增加 (+120ms)，表明家庭沟通模式是主要压力源。</text>
      </view>
...
.status-text {
  color: #ff4757; font-weight: bold; font-size: 14px; letter-spacing: 1px;
}
.report-date {
...
.metric-score { font-size: 18px; font-weight: bold; }
.metric-eval { font-size: 12px; }
.metric-eval.bad { color: #ff4757; }
