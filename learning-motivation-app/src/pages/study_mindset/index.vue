    ...
    <scroll-view scroll-y="true" class="main-content">
      ...
      <view class="glass-card emerald-theme">
        <view class="card-body">
          ...
          <button class="tech-button emerald-btn" hover-class="tech-btn-hover" @click="navigateTo('/pages/survey/index?type=mindset')">
            <view class="btn-glow"></view>
...
export default {
  ...
  methods: {
    goBack() {
      console.log('[StudyMindset] User clicked back button');
      uni.navigateBack();
    },
    navigateTo(url) {
      console.log('[StudyMindset] User navigating to:', url);
      uni.navigateTo({ url });
    },
    showDevToast() {
